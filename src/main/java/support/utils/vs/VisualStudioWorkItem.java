...
public class VisualStudioWorkItem {
	...
	private List<VisualStudioField> fields = new ArrayList<VisualStudioField>();
	private List<VisualStudioRelation> relations = new ArrayList<VisualStudioRelation>();
